...
<div class="container-lg" align="center">
    ...
    <form action="{{ URL::action('VisitController@store') }}" method="POST">
        ...
        <div class=" row row-space justify-content-center">
            <h5>
                Seleziona data, ora e prenota la visita dal tuo medico di base.<button type="submit" name="submit" class="btn btn-outline-success col-lg-2 ml-3">Prenota<svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-plus-circle pl-2" viewBox="0 0 16 16">
