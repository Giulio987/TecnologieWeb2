...
<div class="container-lg align-items-center" align="center">
  ...
  <form action="{{ URL::action('PrescriptionController@store') }}" method="POST">
    ...
    <div class="row row-space justify-content-center">
      <div class="btn btn-outline-primary quadrato-ricetta col-lg-2" onclick="ShowFarmaco()">
        ...
        <div class="btn btn-outline-primary quadrato-ricetta col-lg-2" onclick="ShowVisita()">
