...
@section('content')
                            ...
                            @foreach ($prescriptions as $p)
                                ...
                                <tr class="font-weight-bold text-uppercase" style="color:#626262;">
                                    ...
                                    @if(!strcmp(Auth::user()->role, '1'))
                                        ...
                                        <td  style="-moz-border-radius: 0px 20px 20px 0px;-webkit-border-radius: 0px 20px 20px 0px;border-radius: 0px 20px 20px 0px;"><a href="{{ URL::action('PrescriptionController@destroy', $p) }}" class="btn btn-outline-danger btn-sm confirmDelete">Elimina</a></td>
                                        @else
    ...
    <div class="row-space" style="margin-left:100px;float:left;">
        ...
        <div class="row row-space justify-content-center align-items-center">
            <div class="btn-group btn-group-toggle justify-content-center h-100" data-toggle="buttons" style="padding-right:0px;">
                ...
                <label class="btn btn-outline-primary quadrato-ricetta col-lg-2">
                    ...
                    <label class="btn btn-outline-primary quadrato-ricetta col-lg-3 ml-5">
                        <input type="checkbox" name="convalidare" id="convalidare" style="display:none;">
                        <h4 class="font-weight-bold button-padding">Da convalidare</h4>
                    </label>
                    </div>
        </div>
