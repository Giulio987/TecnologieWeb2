...
@section('content')
    ...
    @if (!strcmp(Auth::user()->role, '2'))
        <!-- Dottore -->
        <div class="container">
            <div class="row row-space-card card-check">
                <div class="col-md-6 my-3">
                    <div class="card h-100 border-card">
                        <img src="images/users/medici.jpg" class="card-img-top dim-img-card" alt="...">
                        <a href="{{ URL::action('PatientController@index') }}">
                            <button type="button" class="btn btn-outline-primary border-button">
                ...
                <div class="col-md-6 my-3">
                    <div class="card h-100 border-card">
                        ...
                        <a href="{{ URL::action('VisitController@index') }}">
                            <button type="button" class="btn btn-outline-primary border-button">
                                <p class="card-text font-weight-bold text-uppercase">le tue visite</p>
                            </button>
                        </a>
                    </div>
                </div>
            </div>
            <div class="row  card-check">
                <div class="col-md-6 my-3">
                    <div class="card h-100 border-card">
                        <img src="images/users/medici.jpg" class="card-img-top dim-img-card" alt="...">
                        <a href="{{ URL::action('PrescriptionController@index') }}">
                            <button type="button" class="btn btn-outline-primary border-button">
                                <p class="card-text font-weight-bold text-uppercase">ricette dei tuoi pazienti</p>
                            </button>
                        </a>
                    </div>
                </div>
                <div class="col-md-6 my-3">
                    <div class="card h-100 border-card">
                        ...
                        <a href="{{ URL::action('PrescriptionController@create') }}">
                            <button type="button" class="btn btn-outline-primary border-button">
                                <p class="card-text font-weight-bold text-uppercase">prescrivi una ricetta</p>
                            </button>
                        </a>
                    </div>
                </div>
